...
public class TriggeredBehaviour_ModifySequencer : TriggeredBehaviour
{
	...
	public SetActivity setActivity = SetActivity.Toggle;
	...
	private void SetBundleActivity (TriggeredBehaviour_Sequencer theBundle)
	{
		switch (setActivity)
		{
			case SetActivity.Toggle :
				theBundle.isActive = !theBundle.isActive;
				break;
			case SetActivity.Activate :
				theBundle.isActive = true;
				break;
			case SetActivity.Deactivate :
				theBundle.isActive = false;
				break;
		}
	}
